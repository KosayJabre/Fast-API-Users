...
def validate_password_strength(password: str) -> PasswordValidationResult:
    ...
    if len(password) < MINIMUM_PASSWORD_LENGTH:
        return PasswordValidationResult(is_valid=False, reason=f"Password must be at least {MINIMUM_PASSWORD_LENGTH} characters long.")
